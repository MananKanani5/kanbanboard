      ...
      {showPopup && (
        <section className='popup'>
          <div className='groupby'>
            <p>Group By </p> 
            <select className='select-dropdown' value={selectedGroup} onChange={handleGroupChange}>
          ...
          <div className='orderby'>
            <p>Sort By </p> 
            <select className='select-dropdown' value={selectedSort} onChange={handleSortChange}>
              <option value="priority">Priority</option>
